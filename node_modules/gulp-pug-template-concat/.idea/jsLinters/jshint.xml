...
<project version="4">
  <component name="JSHintConfiguration" version="2.8.0" use-config-file="true" use-custom-config-file="true" custom-config-file-path="$PROJECT_DIR$/../../mailru/cpf/.jshintrc">
    <option asi="false" />
    <option bitwise="true" />
    <option boss="false" />
    <option browser="true" />
